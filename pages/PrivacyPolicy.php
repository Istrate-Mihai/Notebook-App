...
<head>
  ...
  <title> <?php $title = 'Privacy Policy';
          echo $title; ?> </title>
...
<body>
  <div id="Main-container" class="container">
    <main>
      ...
      <p>This privacy policy ("policy") will help you understand how <span>Your Notebook</span> ("us", "we", "our") uses and
        protects the data you provide to us when you visit and use the website ("website", "service").
      ...
      <p><span>Your Notebook</span> is committed to securing your data and keeping it confidential.<span>Your Notebook</span> has done all in its
      ...
      <p>The data we collect by using cookies is used to customize our website to your needs. After we
      ...
      <h3>Terms and conditions template by WebsitePolicies.com</h3>
      ...
      <p>Our website contains links that lead to other websites. If you click on these links <span>Your Notebook</span> is not held responsible for your data and privacy protection. Visiting those websites is not governed by this privacy policy agreement. Make sure to read the privacy policy documentation of the website you go to from our website. Restricting the Collection of your Personal Data At some point, you might wish to restrict the use and collection of your personal data.</p>
      <p>You can achieve this by doing the following: When you are filling the forms on the website, make sure to check if there is a box which you can leave unchecked, if you don't want to disclose your personal information. If you have already agreed to share your information with us, feel free to contact us via email and we will be more than happy to change this for you.<span>Your Notebook</span> will not lease, sell or distribute your personal information to any third parties, unless we have your permission. We might do so if the law forces us. Your personal information will be used when we need to send you promotional materials if you agree to this privacy policy</p>
    </main>
